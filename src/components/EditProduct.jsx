...
function EditProduct() {
  ...
  return (
    <div className="container-fluid">
      <div className="row bg-secondary text-light font-bold">
        <div class="col-sm-3">
          <img width="200" src={`http://127.0.0.1:9096/${product.photo}`}  />
        </div>
        <div className="col-sm-9">
          <h4 className="text-center p-2">
            <EditIcon></EditIcon>
            Edit Product Form (Product ID : )</h4>
          <form onSubmit={handleSubmit}>
            ...
            <button className="btn btn-success float-centre">
